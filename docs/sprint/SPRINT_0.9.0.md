...
6. 実際に利用する PC 環境で Google Sites から起動する。
...
GitHub Pages は試験公開として採用する。本番運用で厳密な限定公開が必要になった場合は、組織内Webサーバー、Firebase Hosting + 認証、GitHub Enterprise Cloud の private Pages などを再検討する。
